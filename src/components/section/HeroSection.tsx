...
const HeroSection: React.FunctionComponent<IHeroSectionProps> = (props) => {
  ...
  return (
    <section className="relative">
      ...
      <div
        id="background-web"
        className="relative hidden h-[600px] w-full md:block"
      >
        <Image
          fill
          sizes="100vw"
          src="/Laboratorium-virtual.png"
          alt="hero"
      ...
      <header
        id="hero-section"
        className="container absolute  left-1/2 top-1/2 flex h-[550px] -translate-x-1/2 -translate-y-1/2 transform flex-col items-center justify-center justify-items-center md:flex-row"
      >
        <div
          id="left-section"
          className="items-center justify-center md:w-6/12"
        >
          <div className="md:mb-15 mb-[5rem] text-center text-orange-200 md:w-[27rem] md:text-left">
            <h1 className="mb-10 mt-32 text-3xl font-bold md:mt-10 md:text-6xl">
            Modern Innovative Advanced systems
            </h1>
            <p className="text-xl">
            We develop modern, innovative and advanced systems for testing/calibration laboratory accordance with SNI ISO/IEC 17025:2017
            </p>
